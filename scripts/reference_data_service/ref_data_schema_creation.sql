...
CREATE USER IF NOT EXISTS `zeusrefdataadmin`@`%` IDENTIFIED WITH mysql_native_password BY 'password';
...
CREATE USER IF NOT EXISTS `zeusrefdataapp`@`%` IDENTIFIED WITH mysql_native_password BY 'password';
